 ...
 * $HeadURL: file:///mnt/atl-fs8-data1/svn/webtrees-geneajaubart/trunk/library/WT/Perso/Cache.php $
*/
...
class WT_Perso_Cache{
	 ...
	 * @param Module $mod Calling module
	 * @return string Cached key name
	 */
	static private function getKeyName($value, Module $mod = null){
		self::checkInit();
		$mod_name = 'perso';
	 ...
	 */
	static public function isCached($value, Module $mod = null) {
		self::checkInit();
	 ...
	 */
	static public function get($value, Module $mod = null){
		self::checkInit();
	 ...
	 * @return unknown_type Cached value
	 */
	static public function save($value, $data, Module $mod = null){
		self::checkInit();
