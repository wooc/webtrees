...
define('WT_JQUERY_COLORBOX_URL', WT_STATIC_URL . 'assets/js-1.7.7/jquery.colorbox-1.5.14.js');
define('WT_JQUERY_WHEELZOOM_URL', WT_STATIC_URL . 'assets/js-1.7.7/jquery.wheelzoom-2.0.0.js');
...
define('WT_ADMIN_JS_URL', WT_STATIC_URL . 'assets/js-1.7.7/admin.js');
define('WT_AUTOCOMPLETE_JS_URL', WT_STATIC_URL . 'assets/js-1.7.7/autocomplete.js');
define('WT_WEBTREES_JS_URL', WT_STATIC_URL . 'assets/js-1.7.7/webtrees.js');
define('WT_FONT_AWESOME_RTL_CSS_URL', WT_STATIC_URL . 'assets/js-1.7.7/font-awesome-rtl.css');
...
if (Site::getPreference('LOGIN_URL')) {
	...
	define('WT_LOGIN_URL', WT_BASE_URL . url('login'));
}
